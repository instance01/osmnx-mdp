...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "language": "c++",
        "name": "osmnx_mdp.runner",
        "sources": [
            "osmnx_mdp/runner.pyx"
        ]
    },
    "module_name": "osmnx_mdp.runner"
}
END: Cython Metadata */
...
#define __PYX_HAVE__osmnx_mdp__runner
#define __PYX_HAVE_API__osmnx_mdp__runner
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'osmnx_mdp.runner' */
#define __Pyx_MODULE_NAME "osmnx_mdp.runner"
extern int __pyx_module_is_main_osmnx_mdp__runner;
int __pyx_module_is_main_osmnx_mdp__runner = 0;

/* Implementation of 'osmnx_mdp.runner' */
...
static int __Pyx_modinit_function_import_code(void) {
  ...
  __pyx_t_1 = PyImport_ImportModule("osmnx_mdp.mdp_draw"); if (!__pyx_t_1) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction(__pyx_t_1, "run", (void (**)(void))&__pyx_f_9osmnx_mdp_8mdp_draw_run, "PyObject *(void)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_osmnx_mdp__runner) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "osmnx_mdp.runner")) {
      if (unlikely(PyDict_SetItemString(modules, "osmnx_mdp.runner", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "osmnx_mdp/runner.pyx":5
 * 
 * 
 * osmnx_mdp.mdp_draw.run()             # <<<<<<<<<<<<<<
 */
  __pyx_t_1 = __pyx_f_9osmnx_mdp_8mdp_draw_run(); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "osmnx_mdp/runner.pyx":1
 * # cython: language_level=3             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init osmnx_mdp.runner", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init osmnx_mdp.runner");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
