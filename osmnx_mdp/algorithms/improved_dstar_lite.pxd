...
cdef extern from "cpp_improved_dstar_lite.cpp":
    struct pair_hash:
        long long operator(pair[long, long] p)
    cppclass CPP_Improved_DStar_Lite "ImprovedDStarLite":
        ...
        int init(
                ...
                dense_hash_map[pair[long, long], double, pair_hash] *cost,
                dense_hash_map[long, pair[double, double]] *data,
                dense_hash_map[long, dense_hash_map[pair[long, long], double, pair_hash]] *num_outcomes)
...
cdef class ImprovedDStarLite(osmnx_mdp.algorithms.algorithm.Algorithm):
    ...
    cdef dense_hash_map[long, dense_hash_map[pair[long, long], double, pair_hash]] num_outcomes

    cdef MDP mdp
    cdef CPP_Improved_DStar_Lite cpp
